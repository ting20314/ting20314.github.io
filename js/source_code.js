...
//.bindPopup("Marienplatz: Elevators: 4/4 Escalators: 26/28 Service Point: AVAILABLE Barrier-free WC: AVAILABLE")
    a = L.marker([48.13724, 11.57563], {icon: UbahnIcon}).addTo(map).on('click',function () {ctlSidebar.show();ctlSidebar.setContent("<b>Marienplatz</b><br><img src='data/u3.png' width='50'><img src='data/u6.png' width='50'><br>Elevators: 4/4</b><br>Escalators: 26/28</b><br>Service Point: AVAILABLE</b><br>Barrier-free WC: AVAILABLE");}); //Marienplatz
    b = L.marker([48.13938, 11.56585], {icon: UbahnIcon}).addTo(map).on('click',function () {ctlSidebar.show();ctlSidebar.setContent("<b>Karlsplatz</b><br><img src='data/u4.png' width='50'><img src='data/u5.png' width='50'><br>Elevators: 8/8</b><br>Escalators: 37/40</b><br>Service Point: UNAVAILABLE</b><br>Barrier-free WC: UNAVAILABLE")}); //Karlsplatz
    c = L.marker([48.13356, 11.56711], {icon: UbahnIcon}).addTo(map).on('click',function () {ctlSidebar.show();ctlSidebar.setContent("<b>Sendlinger Tor</b><br><img src='data/u1.png' width='50'><img src='data/u2.png' width='50'><br><img src='data/u3.png' width='50'><br><img src='data/u6.png' width='50'><br><img src='data/u7.png' width='50'><img src='data/u8.png' width='50'><br>Elevators: 3/8</b><br>Escalators: 21/30</b><br>Service Point: UNAVAILABLE</b><br>Barrier-free WC: UNAVAILABLE")}); //Sendlinger Tor
    ...
    l = L.marker([48.14507, 11.56337], {icon: UbahnIcon}).addTo(map).on('click',function () {ctlSidebar.show();ctlSidebar.setContent("<b>Königsplatz</b><br><img src='data/u2.png' width='50'><img src='data/u8.png' width='50'><br>Elevators: 1/2</b><br>Escalators: 9/11</b><br>Service Point: UNAVAILABLE</b><br>Barrier-free WC: UNAVAILABLE")}); //Königsplatz
    m = L.marker([48.15113, 11.56418], {icon: UbahnIcon}).addTo(map).on('click',function () {ctlSidebar.show();ctlSidebar.setContent("<b>Theresienstraße</b><br><img src='data/u2.png' width='50'><img src='data/u8.png' width='50'><br>Elevators: 2/2</b><br>Escalators: 8/8</b><br>Service Point: UNAVAILABLE</b><br>Barrier-free WC: UNAVAILABLE")}); //Theresienstraße
    n = L.marker([48.15577, 11.56680], {icon: UbahnIcon}).addTo(map).on('click',function () {ctlSidebar.show();ctlSidebar.setContent("<b>Josephsplatz</b><br><img src='data/u2.png' width='50'><img src='data/u8.png' width='50'><br>Elevators: 1/1</b><br>Escalators: 10/10</b><br>Service Point: UNAVAILABLE</b><br>Barrier-free WC: UNAVAILABLE")}); //Josephsplatz
    ...
    q = L.marker([48.16218, 11.56867], {icon: UbahnIcon}).addTo(map).on('click',function () {ctlSidebar.show();ctlSidebar.setContent("<b>Hohenzollerplatz</b><br><img src='data/u2.png' width='50'><img src='data/u8.png' width='50'><br>Elevators: 1/1</b><br>Escalators: 7/8</b><br>Service Point: UNAVAILABLE</b><br>Barrier-free WC: UNAVAILABLE")}); ///Hohenzollernplatz
