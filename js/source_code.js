...
function closeModal(mmodal) {
    ...
    ctlEasyButton = L.easyButton('fa-exchange', function () {
        ctlSidebar.toggle();
        ctlSidebar.setContent("<b>WE WANT YOUR HELP!</b><br>The more obstacle data you have, <br>the more comprehensive the map is.<br><a href='https://forms.gle/MgLVYHANrJEjkMCX7' target='_blank'>Report Us More Barriers</a>");
    }).addTo(map);
...
L.marker([48.136273, 11.572853], {icon: HousingIcon}).addTo(map).on('click',function () {ctlSidebar.show();ctlSidebar.setContent("<b>No.9741319</b><br>Staring from 01.01.2023</b><br>3G. furnished wg<br>(3 mins from station)</b><br>Rent: 795</b><br>Additional fee: 200</b><br>17 m2</b><br>5 roommates(3F2M)</b><br>Speaking: German, English, Hindi, Spanisch, Norwegisch, Italienisch")});
L.marker([48.155198, 11.565252], {icon: HousingIcon}).addTo(map).on('click',function () {ctlSidebar.show();ctlSidebar.setContent("<b>No.9744113</b><br>Staring from 15.12.2022</b><br>2G. unfurnished wg<br>(1 mins from station)</b><br>Rent: 900</b><br>Deposit: 1800</b><br>19 m2</b><br>2 roommates(2M,21-year-old)</b><br>Speaking: German, English")});
L.marker([48.139908, 11.591901], {icon: HousingIcon}).addTo(map).on('click',function () {ctlSidebar.show();ctlSidebar.setContent("<b>No.8222741</b><br>Staring from 01.11.2022</b><br>1G. part-furnished apartment<br>(4 mins from station)</b><br>Rent: 800</b><br>Additional fee: 80</b><br>Deposit: 2400</b><br>40 m2")});
L.marker([48.138732, 11.590591], {icon: HousingIcon}).addTo(map).on('click',function () {ctlSidebar.show();ctlSidebar.setContent("<b>No.9671143</b><br>Staring from 01.11.2022</b><br>Hochparterre furnished apartment<br>(3 mins from station)<br>4 rooms available</b><br>Rent: 1600</b><br>Additional fee: 250</b><br>Transfer Agreement: 5000</b><br>87 m2")});
L.marker([48.137871, 11.559438], {icon: HousingIcon}).addTo(map).on('click',function () {ctlSidebar.show();ctlSidebar.setContent("<b>No.8275575</b><br>Staring from 22.09.2022</b><br>1G. furnished wg<br>(2 mins from station)</b><br>Rent: 629</b><br>Additional fee: 100</b><br>Deposit: 1258</b><br>15 m2</b><br>1 roommates(1F)</b><br>Speaking: German, English, Turkish")});//1
L.marker([48.137871, 11.559438], {icon: HousingIcon}).addTo(map).on('click',function () {ctlSidebar.show();ctlSidebar.setContent("<b>No.8275552</b><br>Staring from 22.09.2022</b><br>1G. furnished wg<br>(2 mins from station)</b><br>Rent: 679</b><br>Additional fee: 100</b><br>Deposit: 1358</b><br>25 m2</b><br>1 roommates(1F)</b><br>Speaking: German, English, Turkish")});//2
L.marker([48.137871, 11.559438], {icon: HousingIcon}).addTo(map).on('click',function () {ctlSidebar.show();ctlSidebar.setContent("<b>No.8275518</b><br>Staring from 22.09.2022</b><br>2G. furnished wg<br>(2 mins from station)</b><br>Rent: 689</b><br>Additional fee: 120</b><br>Deposit: 1378</b><br>25 m2</b><br>3 roommates(3M)</b><br>Speaking: German, English, Turkish</b><br>Limit: Male Only")});//3
L.marker([48.152249, 11.582348], {icon: HousingIcon}).addTo(map).on('click',function () {ctlSidebar.show();ctlSidebar.setContent("<b>No.9751339</b><br>Staring from 27.11.2022</b><br>3G. furnished wg</b><br>Rent: 850</b><br>Deposit: 1600</b><br>20 m2</b><br>2 roommates(2M)</b><br>Limit: 18-35 Only")});
L.marker([48.155198, 11.565252], {icon: HousingIcon}).addTo(map).on('click',function () {ctlSidebar.show();ctlSidebar.setContent("<b>No.9744113</b><br>Staring from 15.12.2022</b><br>2G. wg<br>(1 mins from station)</b><br>Rent: 900</b><br>Deposit: 1800</b><br>19 m2</b><br>2 roommates(2M)</b><br>Speaking: German, English</b><br>Limit: 19-26 Only")});
L.marker([48.166841, 11.556467], {icon: HousingIcon}).addTo(map).on('click',function () {ctlSidebar.show();ctlSidebar.setContent("<b>No.9590138</b><br>Staring from 01.12.2022</b><br>furnished wg</b><br>Rent: 460</b><br>15 m2</b><br>3 roommates(2F1M)")});//1
L.marker([48.166841, 11.556467], {icon: HousingIcon}).addTo(map).on('click',function () {ctlSidebar.show();ctlSidebar.setContent("<b>No.9689811</b><br>Staring from 16.11.2022</b><br>wg</b><br>Rent: 688<</b><br>20 m2</b><br>3 roommates(2F1M)</b><br>Limit: Only for Ukrainian Refugees")});//2
L.marker([48.166841, 11.556467], {icon: HousingIcon}).addTo(map).on('click',function () {ctlSidebar.show();ctlSidebar.setContent("<b>No.9660183</b><br>Staring from 03.10.2022</b><br>3G. wg<br>(5 mins from station)</b><br>Rent: 500</b><br>20 m2</b><br>1 roommates(1M)</b><br>Speaking: German</b><br>Limit: 40 above Female Only")});//3
